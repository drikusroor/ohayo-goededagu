...
export const previewNoComments = () => {
  ...
  return (
    <div className="p-8">
      <ArticleChotto article={article} displayType={EPostDisplayType.PREVIEW} />
    </div>
  )
}

export default {
  title: 'Components/ArticleChotto',
  component: ArticleChotto,
} as ComponentMeta<typeof ArticleChotto>
